...
const Footer = () => {
    return (
        <div>
            <footer class="footer px-5 py-10 bg-base-200 text-base-content bg-black text-white ">
                <div>
            ...
            <footer class="footer px-10 py-4 border-t text-base-content border-base-300 bg-slate-200">
